...
If anyone from Google reads this and can explain what happened—or lift the suspension with clear guardrails?
...
Thanks to everyone who helped investigate and get things working again. I really appreciate it.

This whole incident also pushed me to make a few positive changes. I’m rewriting the metrics app to be more portable, with adapters that decouple it from any one provider, and I’ve converted the project to TypeScript so I can define stronger boundaries between the front end and back end.
