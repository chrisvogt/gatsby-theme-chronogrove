...
Thank you to everyone who investigated and helped get things working again—I really appreciate it.

The incident helped push me to make some positive changes: (1) I'm rewriting the metrics app to be more portable, with adapters that decouple it from a specific provider, and (2) I've converted the project to TypeScript and am defining types to tighten the contract between the front end and the back end.
